    ...
    >
      ...
      <span className="relative z-10 block px-6 py-3 rounded-xl bg-gray-950">
        <div className="relative z-10 flex items-center space-x-2">
          <Link to="/contact" className="transition-all duration-500 group-hover:translate-x-1">Let's get started</Link>
          <svg
          ...
          >
            ...
            ></path>
              ...
              <img className="w-[550px] aspect-square rounded-lg" src={kuch.img} alt="" />
            </section>
          );
        })}
      </div>
