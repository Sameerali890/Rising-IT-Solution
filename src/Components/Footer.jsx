...
function Footer() {
  return (
    <section>
      <footer className="border bg-base-200 flex justify-around gap-20  text-base-content p-10" >
        <nav className="grid">
      <h6 className="font-bold text-2xl">Services</h6>
      <a className="hover:text-blue-500 cursor-pointer">Website Developemnt</a>
      <a className="hover:text-blue-500 cursor-pointer">Android App Development</a>
      <a className="hover:text-blue-500 cursor-pointer">E-commerce</a>
      <a className="hover:text-blue-500 cursor-pointer">Digital Marketing</a>
        </nav>
